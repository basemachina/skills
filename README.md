...
| skill | 使う場面 |
| --- | --- |
| [`official-docs`](skills/official-docs/) | 公式ドキュメント URL を検索・閲覧し、仕様・使い方・制約・最新情報に根拠付きで回答 |
...
`bm-code-management` は、BaseMachina のコード管理 repo を編集するときのガードレールです。アクションの実行、本番反映、ビュー設定そのものの変更は扱いません。
